							...
							<div>
								<ul class="nav nav-pills bg-nav-pills nav-fill">
								  <li class="nav-item b-1">
									<a class="nav-link text-center" href="#">51 <br>Active</a>
								  </li>
								  <li class="nav-item b-1">
									<a class="nav-link text-center" href="#">41 <br>Inactive</a>
								  </li>
								  <li class="nav-item b-1">
									<a class="nav-link text-center" href="#">0 <br>Paid</a>
								  </li>
								  <li class="nav-item b-1">
									<a class="nav-link text-center" href="#">10 <br>UnPaid</a>
								  </li>
								  <li class="nav-item b-1">
									<a class="nav-link text-center" href="#">0 <br>Unverified-Email</a>
								  </li>
								  <li class="nav-item b-1">
