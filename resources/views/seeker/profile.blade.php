					...
					<div class="card text-center">
						<div class="card-body">
							...
							<div class="text-start mt-3">
								...
								<p class="text-muted mb-2 "><strong class="text-info">Full Name :</strong> <span class="ms-2">{{$seekers->firstname . " ".$seekers->lastname}}</span></p>

								<p class="text-muted mb-2 "><strong class="text-info">Mobile :</strong><span class="ms-2">{{$seekers->mobile}}</span></p>

								<p class="text-muted mb-2 "><strong class="text-info">Email :</strong> <span class="ms-2 ">{{$seekers->email}}</span></p>
						...
						<div class="card-body">
							...
							<div class="tab-content">
								...
								<div class="tab-pane active" id="settings">
									<form action="{{url('/seeker/update-profile')}}" method="POST">
									    @csrf
										<h5 class="mb-4 text-uppercase"><i class="mdi mdi-account-circle me-1"></i> Personal Info</h5>
										<div class="row">
											<div class="col-md-6">
												<div class="mb-3">
													<label for="firstname"  value="" class="form-label">First Name</label>
													<input type="text" name="firstname" value="{{$seekers->firstname}}" class="form-control" id="firstname">
												</div>
											</div>
											<div class="col-md-6">
												<div class="mb-3">
													<label for="lastname"  class="form-label">Last Name</label>
													<input type="text" name="lasttname" value="{{$seekers->lastname}}" class="form-control" id="lastname">
												</div>
											</div> <!-- end col -->
										</div> <!-- end row -->
										...
										<div class="row">
											<div class="col-12">
												<div class="mb-3">
													<label for="userbio" class="form-label"></label>
											...
											<div class="col-md-6">
												<div class="mb-3">
													...
													<div class="input-group">
														...
														<input type="text" name="facebook_url" class="form-control" value="{{@$info->facebook_url}}" id="social-fb">
													</div>
												</div>
											</div>
											<div class="col-md-6">
												<div class="mb-3">
													...
													<div class="input-group">
														...
														<input type="text" name="twitter_url" value="{{@$info->twitter_url}}" class="form-control" id="social-tw">
													</div>
												</div>
											</div> <!-- end col -->
										</div> <!-- end row -->
											...
											<div class="col-md-6">
												<div class="mb-3">
													...
													<div class="input-group">
														...
														<input type="text" name="instagram_url" value="{{@$info->instagram_url}}" class="form-control" id="social-insta">
													</div>
												</div>
											</div>
											<div class="col-md-6">
												<div class="mb-3">
													...
													<div class="input-group">
														...
														<input type="text" name="linkedin_url" value="{{@$info->linkedin_url}}" class="form-control" id="social-lin">
													</div>
												</div>
											</div> <!-- end col -->
										</div> <!-- end row -->
