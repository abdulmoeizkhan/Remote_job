		...
		<div class="row">
			<div class="col-12">
			  <div class="box">
				...
				<!-- /.box-header -->
				<div class="box-body">
				  <form role="form" method="POST" action="{{url('/admin-add-article')}}">
				      @csrf
					...
					<div class="form-group">
					  <label class="form-label">Title</label>
                          <input class="form-control" placeholder="Enter a Title"  maxlength="54" name="title" >
       						 @error('title')
			...
			@enderror
					...
					<div class="form-group">
					  <label class="form-label">Content</label>
					   <textarea class="form-control" value="" id="body" placeholder="Enter a content" name="content" rows="3"  >
