                        ...
                        <div class="box-body">
                            <div class="table-responsive">
                              <div id="example5_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4"><div class="row"><div class="col-sm-12 col-md-6"><div class="dataTables_length" id="example5_length"><label>Show <select name="example5_length" aria-controls="example5" class="form-control form-control-sm" fdprocessedid="k7pg1b"><option value="10">10</option><option value="25">25</option><option value="50">50</option><option value="100">100</option></select> entries</label></div></div><div class="col-sm-12 col-md-6"><div id="example5_filter" class="dataTables_filter"><label>Search:<input type="search" class="form-control form-control-sm" placeholder="" aria-controls="example5"></label></div></div></div><div class="row"><div class="col-sm-12"><table id="example5" class="table table-bordered table-striped dataTable" style="width: 100%;" role="grid" aria-describedby="example5_info">
                                <thead>
                                    <tr role="row"><th class="sorting_asc" tabindex="0" aria-controls="example5" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column descending" style="width: 199px;">Name</th><th class="sorting" tabindex="0" aria-controls="example5" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending" style="width: 212px;">Position</th><th class="sorting" tabindex="0" aria-controls="example5" rowspan="1" colspan="1" aria-label="Office: activate to sort column ascending" style="width: 199px;">Office</th><th class="sorting" tabindex="0" aria-controls="example5" rowspan="1" colspan="1" aria-label="Age: activate to sort column ascending" style="width: 199px;">Age</th><th class="sorting" tabindex="0" aria-controls="example5" rowspan="1" colspan="1" aria-label="Start date: activate to sort column ascending" style="width: 199px;">Start date</th><th class="sorting" tabindex="0" aria-controls="example5" rowspan="1" colspan="1" aria-label="Salary: activate to sort column ascending" style="width: 198px;">Salary</th></tr>
                                </thead>
                                <tbody>
                                    <h1>All Jobs page</h1>
                                ...
                                <tfoot>
                                    <tr><th rowspan="1" colspan="1"><input type="text" placeholder="Search Name" fdprocessedid="n5j7da"></th><th rowspan="1" colspan="1"><input type="text" placeholder="Search Position" fdprocessedid="4dfaju"></th><th rowspan="1" colspan="1"><input type="text" placeholder="Search Office" fdprocessedid="w85x77"></th><th rowspan="1" colspan="1"><input type="text" placeholder="Search Age" fdprocessedid="zhkqxl"></th><th rowspan="1" colspan="1"><input type="text" placeholder="Search Start date" fdprocessedid="bzvdgq"></th><th rowspan="1" colspan="1"><input type="text" placeholder="Search Salary" fdprocessedid="w8d8d7"></th></tr>
                                </tfoot>
