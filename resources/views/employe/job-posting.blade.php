...
@endif				    
		...
		@enderror
		  ...
		  <div class="form-group row align-items-center">
			...
			<div class="col-sm-9">
			  <textarea name="schedule" wrap="soft" cols="50" rows="2" class="form-control h-50"></textarea>
			</div>
		  </div>
...
<div class="form-group row align-items-center">
    ...
    <div class="col-sm-9 d-flex">
	  ...
	  <label class="form-check-label me-3" for="radio_relocate2">Hybrid Remote</label>
		   ...
		   <div class="form-group row align-items-center">
			<label for="inputPassword" class="col-sm-3 col-form-label text-right">Contact CheckBox :</label>
							<div class="col-sm-1">
                    				  <div class="form-check">
                                          <input class="form-check-input" type="checkbox" value="" onclick="show_contact()" id="flexCheckDefault">
                                          <label class="form-check-label" for="flexCheckDefault"></label>
                                        </div>
				</div>
		  </div>
		  
		  <div class="form-group row align-items-center d-none" id="wireless_number">
			<label for="inputPassword" class="col-sm-3 col-form-label text-right">Wireless Number :</label>
			<div class="col-sm-9">
		   ...
		   <label for="inputPassword" class="col-sm-3 col-form-label text-right">&nbsp;</label>
			<div class="col-sm-9">
			  <input type="submit" name="Preview" value="Preview" class="btn btn-primary">
					    ...
					    <?php }else{
					    echo 'Job posting limit for this account has been reached. Please 
					    Click the link below to update your subscription plan';
					    }
					    ?>
...
function change_reside_status(status){
  ...
  function show_contact(){
      ...
      $('#wireless_number').removeClass('d-none');
        }else{
      $('#wireless_number').addClass('d-none');
        }
