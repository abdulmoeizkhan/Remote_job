...
<html lang="en">
 <head>
    ...
    <title>RemotePhase - Dashboard</title>
	...
	<div class="d-flex align-items-center logo-box justify-content-start">
		...
		<a href="index.html" class="logo">
		  ...
		  <div class="logo-lg">
			  ...
			  <span class="dark-logo"><img src="{{asset('logo.png')}}" alt="logo"></span>
		  </div>
		</a>	
	</div>  
    <!-- Header Navbar -->
        ...
        <ul class="nav navbar-nav">	
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu animated flipInX">
              <li class="user-body">
				 <a class="dropdown-item" href="{{ url('employe-edit-profile') }}"><i class="ti-user text-muted me-2"></i> Profile</a>
				 <a class="dropdown-item" href="#"><i class="ti-wallet text-muted me-2"></i> My Wallet</a>
				 <a class="dropdown-item" href="{{url('employe-setting')}}"><i class="ti-settings text-muted me-2"></i> Settings</a>
				 <div class="dropdown-divider"></div>
				 <a class="dropdown-item" href="{{url('signout')}}"><i class="ti-lock text-muted me-2"></i> Logout</a>
              </li>
            </ul>
          </li>	
        </ul>
