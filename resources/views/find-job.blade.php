...
<div class="" style="margin-bottom:-20px;" id="data">
                                    ...
                                    <div class="card my-card  p-3 mb-5 " style="border-radius: 8px; background-color:#aec5f6;">
                                        <div class="row">
                                            <p style="color:black;  font-size:14px; font-weight:600; margin:0px"
                                                class="">Save Your Search And Subscribe To Job Alerts 
                                                
                                            </p>

                                          <p style="color:black;  font-size:14px; font-weight:600; margin:0px"
                                                class="">
                                             Get director of product managmenti in Remote results <br>
                                             delivered to you
                                            </p>
                                        </div>
                                      
                                        <label class="" style="color:black; margin-top:20px;">Email address</label>     
                                        <input class="form-control" style="border-radius: 13px; color:#686781; margin-bottom:20px;">
                                            
                                        

                                        <span style=""> 
                                
                                      <a href="{{ url('seekerjobs') }}" style="border-radius: 13px" class="btn btn-primary float-right">
                                
                                    Save and Subscription
                                </a>
                                        </span>
                                    </div>
                                </div>
