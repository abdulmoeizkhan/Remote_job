...
<!-- ./wrapper -->
 ...
 <!--           </div>-->
	...
	<script src="{{asset('seeker/assets/vendor_components/apexcharts-bundle/dist/apexcharts.js')}}"></script>
	
	<!-- Joblly App -->
	<script src="{{asset('seeker/js/template.js')}}"></script>
	<script src="{{asset('seeker/js/pages/dashboard2.js')}}"></script>
