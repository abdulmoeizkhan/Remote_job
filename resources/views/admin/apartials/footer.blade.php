...
<!-- 	
	<script src="{{asset('admin/src/js/vendors.min.js')}}"></script>
	<script src="{{asset('admin/src/js/pages/chat-popup.js')}}"></script>
	...
	<!-- EmployX App -->
	<script src="{{asset('admin/src/js/demo.js')}}"></script>
	<script src="{{asset('admin/src/js/template.js')}}"></script>
	<script src="{{asset('admin/src/js/pages/dashboard.js')}}"></script>
